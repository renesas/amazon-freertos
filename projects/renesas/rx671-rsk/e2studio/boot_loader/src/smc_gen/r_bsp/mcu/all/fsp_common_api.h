...
typedef enum e_fsp_err
{
    ...
    /* Start of COMM specific */
    FSP_ERR_COMM_IN_USE           = 0x40000, ///< Communication line is in use.
    FSP_ERR_COMM_ARBITRATION_LOST = 0x40001, ///< Arbitration is lost.
    FSP_ERR_COMM_TIMEOUT          = 0x40002, ///< Communication is timeout.
    FSP_ERR_COMM_NACK             = 0x40003, ///< NACK is detected.
    FSP_ERR_COMM_OTHER            = 0x40004, ///< Other error is detected in communication.
} fsp_err_t;
