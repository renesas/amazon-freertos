...
//static int32_t wifi_dns_query(uint8_t *domain_name, uint32_t *ipaddress);
...
#else
	        sprintf((char *)g_wifi_uart[wifi_command_port].command_buff, "ATBX1=%lu,,,,\r",WIFI_CFG_SCI_BAUDRATE);
#endif
