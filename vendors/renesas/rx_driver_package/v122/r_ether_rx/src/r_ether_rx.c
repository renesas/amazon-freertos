    ...
    if (ETHER_FLAG_ON_LINK_ON == lchng_flag[channel])
    {
        ...
        */
        ...
        else
        {
            /* When PHY auto-negotiation is not completed */
            transfer_enable_flag[channel] = ETHER_FLAG_OFF;
<<<<<<< HEAD:vendors/renesas/FIT/RDP_v1.15_modified/r_ether_rx/src/r_ether_rx.c
           	lchng_flag[channel] = ETHER_FLAG_ON_LINK_ON;
=======
            lchng_flag[channel] = ETHER_FLAG_ON_LINK_ON;
>>>>>>> [UPDATED] FIT Modules to latest (RX Driver Package v122).:vendors/renesas/rx_driver_package/v122/r_ether_rx/src/r_ether_rx.c
        }
#endif
    }
