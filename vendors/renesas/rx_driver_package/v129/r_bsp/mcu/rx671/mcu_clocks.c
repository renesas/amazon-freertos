...
static void clock_source_select (void)
{
    ...
    if (1 == SYSTEM.HOCOCR.BIT.HCSTP)
    {
        ...
        {
            SYSTEM.HOCOTRR0.LONG = (0xFFFFF700 | BSP_CFG_HOCO_TRIMMING_REG_VALUE);
        }
        else if(0x01 == SYSTEM.HOCOCR2.BYTE) // 18MHz
        {
            SYSTEM.HOCOTRR1.LONG = (0xFFFFF700 | BSP_CFG_HOCO_TRIMMING_REG_VALUE);
        }
        else                                 // 20MHz
        {
            SYSTEM.HOCOTRR2.LONG = (0xFFFFF700 | BSP_CFG_HOCO_TRIMMING_REG_VALUE);
        }
        #endif
