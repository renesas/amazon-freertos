...
#define MEMDRV_CFG_DEV0_MODE_DRVR_CH      (MEMDRV_DRVR_CH1)
#define MEMDRV_CFG_DEV1_MODE_DRVR_CH      (MEMDRV_DRVR_CH1)
...
#define MEMDRV_CFG_DEV0_BR                ((uint32_t)(30000000))
                                        /* Device 0 Transfer rate for command transmission.     */
#define MEMDRV_CFG_DEV0_BR_WRITE_DATA     ((uint32_t)(30000000))
                                        /* Device 0 Transfer rate for data transmission.        */
#define MEMDRV_CFG_DEV0_BR_READ_DATA      ((uint32_t)(30000000))
