...
extern volatile __evenaccess uint16_t * const  dreg2_ptrs[];
#endif
...
#endif // #if (!defined(BSP_MCU_RX64M) && !defined(BSP_MCU_RX65_ALL) && !defined(BSP_MCU_RX66T) && !defined(BSP_MCU_RX71M))
