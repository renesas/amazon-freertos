...
set MODIFIED_FIT_MODULES=r_bsp r_ether_rx r_flash_rx r_sci_rx r_byteq r_s12ad_rx r_tfat_driver_rx r_tfat_rx r_usb_basic r_usb_hmsc r_sys_time_rx r_cmt_rx
